...
export async function obterMetaAutomatica(id_dadosUsuario) {
    ...
    const url = `http://ec2-18-230-228-181.sa-east-1.compute.amazonaws.com:8080/meta/auto/${id_dadosUsuario}`;
...
export async function obterMetaManual(id_dadosUsuario) {
    const url = `http://ec2-18-230-228-181.sa-east-1.compute.amazonaws.com:8080/meta/manual/${id_dadosUsuario}`;
...
export async function atualizarMetaManual(id_dadosUsuario, novaMetaManual) {
    ...
    try {
        const response = await fetch(`http://ec2-18-230-228-181.sa-east-1.compute.amazonaws.com:8080/meta/manual/${id_dadosUsuario}`, {
            method: 'PUT',
            headers: {
        ...
        // Aqui você pode lidar com o erro de acordo com sua necessidade
